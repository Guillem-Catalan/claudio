"""
Generate re-engagement brief for stalled deals.
"""
...
_PROMPTS_DIR = Path(__file__).resolve().parent.parent.parent.parent / "prompts" / "pae_followup" / "stalled"
...
def generate_brief(subtype: str, data: dict) -> dict:
    ...
    if not prompt_file.exists():
        prompt_file = _PROMPTS_DIR / "ghost.txt"
