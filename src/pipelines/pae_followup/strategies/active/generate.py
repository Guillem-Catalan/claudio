"""
Generate follow-up brief for active deals using the subtype-specific prompt.
"""
...
_PROMPTS_DIR = Path(__file__).resolve().parent.parent.parent.parent / "prompts" / "pae_followup" / "active"
...
def generate_brief(subtype: str, data: dict) -> dict:
    ...
    if not prompt_file.exists():
        prompt_file = _PROMPTS_DIR / "standard.txt"
    ...
    raw = analyze(system_prompt, user_prompt, max_tokens=8000)
